...
class RiemannZeta(Scene):
    def construct(self):
        ...
        for i in np.arange(1, 100, 2):
            ...
            zz1 = mpmath.zeta(complex((1/2), (i+2)))
            d1 = float(zz1.real)
            e1 = float(zz1.imag)
            f1 = i + 2
        ...
        for i in np.arange(1, 100, 1):
            ...
            # build coords 1 point in the future
            zz1 = mpmath.zeta(complex((1/2), (i+1)))
            d1 = float(zz1.real)
            e1 = float(zz1.imag)
            f1 = i + 1
        ...
        for i in np.arange(1, 100, .5):
            ...
            # build coords 1 point in the future
            zz1 = mpmath.zeta(complex((1/2), (i+.5)))
            d1 = float(zz1.real)
            e1 = float(zz1.imag)
            f1 = i + .5
        ...
        trace_group_4.shift(DOWN * 2, RIGHT * 3).scale(.4)

        # build latex for each resolution
        trace_1_text_string = '\\zeta(\\frac{1}{2} + it)'
        trace_1_rt_string = 'S(t) = 1, L(t) = 100, R(t) = 2'
        ...
        trace_2_text_string = '\\zeta(\\frac{1}{2} + it)'
        ...
        trace_3_text_string = '\\zeta(\\frac{1}{2} + it)'
        trace_3_rt_string = 'S(t) = 1, L(t) = 100, R(t) = 0.5'
        ...
        trace_4_text_string = '\\zeta(\\frac{1}{2} + it)'
        trace_4_rt_string = 'S(t) = 1, L(t) = 100, R(t) = 0.1'
